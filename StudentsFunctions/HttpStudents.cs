...
public class HttpStudents
{
    ...
    public HttpStudents(ILoggerFactory loggerFactory, SchoolContext context)
{
    _logger = loggerFactory.CreateLogger<HttpStudents>();
    _context = context;
}


    public HttpStudents(ILogger<HttpStudents> logger)
    {
        _logger = logger;
    }
...
)
{
  ...
  return response2;
    ...
    [Function("WelcomeAzureFunctions")]
